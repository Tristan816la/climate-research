...
(function () {
  var data = {
    resource: {
      ...
      tags: [
        ...
        { function: '__paused', vtp_originalTagType: 'html', tag_id: 2 },
        { function: '__paused', vtp_originalTagType: 'html', tag_id: 3 },
        { function: '__paused', vtp_originalTagType: 'gclidw', tag_id: 5 },
        { function: '__paused', vtp_originalTagType: 'opt', tag_id: 6 },
        ...
        { function: '__paused', vtp_originalTagType: 'html', tag_id: 18 },
        {
          function: '__gaawc',
          metadata: ['map'],
          once_per_event: true,
          vtp_sendPageView: true,
          vtp_measurementId: 'G-M74X3FDJH0',
        ...
        { function: '__paused', vtp_originalTagType: 'html', tag_id: 94 },
        {
          ...
          vtp_measurementId: 'G-32380ETVM7',
          vtp_enableUserProperties: true,
          vtp_enableEuid: false,
          tag_id: 96,
        },
        {
          function: '__tg',
          vtp_triggerIds: ['list', '12445754_11_73', '12445754_11_7'],
          vtp_uniqueTriggerId: '12445754_11',
          tag_id: 97,
        },
        {
          function: '__tg',
          vtp_isListeningTag: true,
          vtp_firingId: '12445754_11_73',
          tag_id: 98,
        },
        {
          function: '__tg',
          vtp_isListeningTag: true,
          vtp_firingId: '12445754_11_7',
          tag_id: 100,
        },
        {
          function: '__tg',
          vtp_triggerIds: ['list', '12445754_70_11', '12445754_70_38'],
          vtp_uniqueTriggerId: '12445754_70',
          tag_id: 101,
        },
        {
          function: '__tg',
          vtp_isListeningTag: true,
          vtp_firingId: '12445754_70_11',
          tag_id: 102,
        },
        {
          function: '__tg',
          vtp_isListeningTag: true,
          vtp_firingId: '12445754_70_38',
          tag_id: 104,
        },
        {
          function: '__tg',
          vtp_triggerIds: ['list', '12445754_74_73', '12445754_74_2147479553'],
          vtp_uniqueTriggerId: '12445754_74',
          tag_id: 105,
        },
        {
          function: '__tg',
          vtp_isListeningTag: true,
          vtp_firingId: '12445754_74_73',
          tag_id: 106,
        },
        {
          function: '__tg',
          vtp_isListeningTag: true,
          vtp_firingId: '12445754_74_2147479553',
          tag_id: 108,
        },
        {
          function: '__html',
          ...
          once_per_load: true,
          vtp_html:
            '\u003Cscript type="text/gtmscript"\u003E(function(a,e,f,g,b,c,d){a.GoogleAnalyticsObject=b;a[b]=a[b]||function(){(a[b].q=a[b].q||[]).push(arguments)};a[b].l=1*new Date;c=e.createElement(f);d=e.getElementsByTagName(f)[0];c.async=1;c.src=g;d.parentNode.insertBefore(c,d)})(window,document,"script","//www.google-analytics.com/analytics.js","ga");ga("create","UA-21850385-1","auto");ga("set","forceSSL",!0);ga("set","anonymizeIp",!0);ga("require","displayfeatures");0\u003Cwindow.parent.frames.length\u0026\u0026ga("set","embedded","yes");ga("send","pageview");\nwindow.ga=ga;console.log("ga loaded");\u003C/script\u003E',
        ...
        },
        {
          ...
          once_per_event: true,
          vtp_html:
            '\u003Cscript async data-gtmsrc="https://www.googletagmanager.com/gtag/js?id=AW-972604109" type="text/gtmscript"\u003E\u003C/script\u003E\u003Cscript type="text/gtmscript"\u003Ewindow.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag("js",new Date);gtag("config","AW-972604109");\u003C/script\u003E',
          vtp_supportDocumentWrite: false,
          vtp_enableIframeMode: false,
          vtp_enableEditJsMacroBehavior: false,
          tag_id: 16,
      ...
      predicates: [
        ...
        { function: '_eq', arg0: ['macro', 0], arg1: 'gtm.js' },
        {
          function: '_cn',
          arg0: ['macro', 2],
          arg1: 'https://www.plugshare.com/trip-planner.html',
        },
        {
          function: '_eq',
          arg0: ['macro', 2],
          arg1: 'https://www.plugshare.com',
        },
        {
          function: '_re',
          arg0: ['macro', 1],
        ...
        { function: '_eq', arg0: ['macro', 0], arg1: 'gtm.loadAnalytics' },
        { function: '_eq', arg0: ['macro', 0], arg1: 'gtm.loadMarketing' },
        { function: '_eq', arg0: ['macro', 0], arg1: 'gtm.registerSuccess' },
      ],
      rules: [
        [
          ['if', 0, 1],
  ...
  var pa = function (a) {
    ...
    for (var b in a)
      a.hasOwnProperty(b) &&
        (ma(b) ? (this.g[Number(b)] = a[Number(b)]) : this.o.set(b, a[b]));
  };
  h = pa.prototype;
  ...
  sa.prototype.set = function (a, b) {
    !this.o.has(a) && this.g && this.g.has(a)
      ? this.g.set(a, b)
      : (this.s.Ve(
          ('string' === typeof a ? a.length : 1) +
            ('string' === typeof b ? b.length : 1)
  ...
  var pb = function (a, b, c, d) {
      ...
      f = new $a(k, Za);
      e.src =
        f instanceof $a && f.constructor === $a
          ? f.g
    ...
    Jb = function (a) {
      ...
      try {
        if (
          a.constructor &&
          !Ib(a, 'constructor') &&
          !Ib(a.constructor.prototype, 'isPrototypeOf')
        )
          return !1;
      } catch (c) {
        return !1;
    ...
    N = function (a, b) {
      ...
      for (d in a)
        if (Ib(a, d)) {
          var e = a[d];
          'array' == Hb(e)
            ? ('array' != Hb(c[d]) && (c[d] = []), (c[d] = N(e, c[d])))
            : Jb(e)
            ? (Jb(c[d]) || (c[d] = {}), (c[d] = N(e, c[d])))
            : (c[d] = e);
        }
      return c;
    };
      ...
      var d = [],
        ...
        g = function (k) {
          ...
          if (k instanceof Ua) {
            var u = function () {
              for (
                var v = Array.prototype.slice.call(arguments, 0), y = 0;
                y < v.length;
                y++
              )
                v[y] = Kb(v[y], b, c);
        ...
        g = function (k) {
          ...
          if ('function' === typeof k) {
            var r = new Ua('', function (w) {
              for (
                var A = Array.prototype.slice.call(arguments, 0), z = 0;
                z < A.length;
                z++
              ) {
                var D = z,
                ...
                if (za(C)) {
                  ...
                  try {
                    ...
                    if (!(G && G instanceof Ua))
                      throw Error(
                        'Attempting to execute non-function ' + J[0] + '.'
                      );
                    ...
                    K &&
                      K(
                        Q,
                        J.context ? { id: J[0], line: J.context.line } : null
                      );
                    throw Q;
                  }
                } else E = C;
        ...
        switch (a[0]) {
          ...
          case 'macro':
            ...
            try {
              ...
              d = uc(m, { event: b, index: f, type: 2, name: k });
              tc && (d = tc.Gi(d, m));
            } catch (w) {
  ...
  var Bc = {
    Gi: function (a, b) {
      b[Nb.yf] &&
        'string' === typeof a &&
        (a = 1 == b[Nb.yf] ? a.toLowerCase() : a.toUpperCase());
      ...
      if ('' === d || p === e || (p === d ? n !== e : !p && !n)) {
        ...
        q &&
          H.setTimeout(function () {
            k[a] === r &&
              r.quiet &&
              ((r.quiet = !1), wd(a), vd(), kd('TAGGING', 2));
          }, f);
      }
    }
  }
  ...
  function vd(a, b) {
    for (var c = 0; c < qd.length; ++c) {
      ...
      if (d.$g) {
        d.$g = !1;
        try {
          d.Ti({ consentEventId: a, consentPriorityId: b });
        } catch (e) {}
      }
    }
  }
  ...
  var yd = function (a) {
    ...
    Fd = function (a, b) {
      function c() {
        for (var e = 0; e < b.length; e++) if (!Ad(b[e])) return !0;
        return !1;
      }
      if (c()) {
        var d = !1;
  ...
  re.W = 'dataLayer';
  re.zh =
    'ChEI8KXDkwYQ48mSzq+GhO/8ARIkAPOUfb/ryBJisv3+LhDzl2UI80VD9I+AxrgfbgtVZ+PjRdwCGgKsLQ\x3d\x3d';
  var te = {
      __cl: !0,
      __ecl: !0,
      __ehl: !0,
  ...
  function Of(a, b, c) {
    for (var d = [], e = Nf(a, void 0, void 0, c), f = 0; f < e.length; f++) {
      ...
      if (!b || -1 !== b.indexOf(k)) {
        ...
        m &&
          ((m = m.split('-')),
          d.push({ id: g.join('.'), Ld: 1 * m[0] || 1, Rc: 1 * m[1] || 1 }));
      }
    }
    return d;
  }
  ...
  function jg(a, b, c) {
    ...
    var e = d.split('.');
    5 === e.length
      ? ((gg[a] = e.slice(0, 2).join('.')),
        (hg[a] = { id: e.slice(2, 4).join('.'), Sg: Number(e[4]) || 0 }))
      : 3 === e.length
      ? (hg[a] = { id: e.slice(0, 2).join('.'), Sg: Number(e[2]) || 0 })
      : (gg[a] = d);
    return !0;
  }
  function ig(a) {
  ...
  var ch = /^\w+$/,
    dh = /^[\w-]+$/,
    eh = { aw: '_aw', dc: '_dc', gf: '_gf', ha: '_ha', gp: '_gp', gb: '_gb' },
    fh = function () {
      if (!pd().g() || !Bd()) return !0;
      var a = yd('ad_storage');
      return null == a ? !0 : !!a;
        ...
        if (null != f) {
          ...
          p
            ? ((p.timestamp = Math.max(p.timestamp, m)),
              (p.labels = kh(p.labels, n || [])))
            : b.push({ version: k, za: d.$c, timestamp: m, labels: n });
        }
      }
      b.sort(function (q, r) {
  ...
  function ph(a, b, c, d, e) {
    ...
    a.gp && f('gp', p(a.gp[0]));
    if (
      (void 0 == bh.enable_gbraid_cookie_write
        ? 0
        : bh.enable_gbraid_cookie_write) &&
      !m &&
      a.gb
    ) {
      var q = a.gb[0],
          ...
          if (void 0 !== eh[f]) {
            ...
            if (k) {
              ...
              b: {
                ...
                if (Kf(H))
                  for (
                    var q = Nf(g, I.cookie, void 0, 'ad_storage'), r = 0;
                    r < q.length;
                    ++r
                  )
                    if (sh(q[r]) > p) {
  ...
  var ai = { H: 'GTM-W752VQ4', hc: '12445754' },
    bi = { Yg: 'GTM-W752VQ4', Zg: 'GTM-W752VQ4' },
    ci = function () {
      var a = [ai.H];
      return a;
    },
  ...
  var ji = function (a) {},
    ...
    pi = function (a) {
      ...
      return [
        ...
        Fi,
        Ci,
        Di ? '&dl=' + encodeURIComponent(Di) : '',
        0 < Ei.length ? '&tdp=' + Ei.join('.') : '',
        '&z=0',
      ].join('');
    },
    Li = function () {
    ...
    mi = ['L', 'S', 'Y'],
    ii = ['S', 'E'],
    Ni = { sampleRate: '0.005000', sh: '', rh: Number('5') },
    Oi =
  ...
  var Si = Pi,
    Mi = 'https://www.googletagmanager.com/a?id=' + ai.H + '&cv=86',
    Ti = {
  ...
  var ej = function (a, b, c) {
    ...
    fj = function (a, b, c) {};
  var gj = { initialized: 11, complete: 12, interactive: 13 },
    hj = {},
  ...
  function lk(a, b, c, d) {
    ...
    if (n && n.length) {
      var p = n[0],
        q = kk(p.index, { onSuccess: g, onFailure: k, terminate: m }, c, d);
      if (!q) return null;
      g = q;
      k = 2 === p.Ig ? m : q;
    }
  ...
  cb('Edge');
  !cb('Gecko') ||
    (-1 != bb().toLowerCase().indexOf('webkit') && !cb('Edge')) ||
    cb('Trident') ||
    cb('MSIE') ||
    cb('Edge');
        ...
        if (a.purpose && a.vendor) {
          ...
          m =
            n && '1' === b && a.purposeOneTreatment && 'CH' === a.publisherCC
              ? !0
              : n && bl(a.purpose.consents, b);
        } else m = !0;
      else
        m =
          1 === k
            ? a.purpose && a.vendor
              ? bl(a.purpose.legitimateInterests, b) &&
                bl(a.vendor.legitimateInterests, void 0 === d ? '755' : d)
              : !0
            : !0;
      return m;
    },
  ...
  var ol = function () {
    var a = jl(),
      b = new $k(H, fl ? 3e3 : -1);
    if (
      !0 === H.gtag_enable_tcf_support &&
      !a.active &&
      ('function' === typeof H.__tcfapi ||
  ...
  function ml(a) {
    ...
    Pd(
      c,
      { eventId: 0 },
      { gdprApplies: a ? a.gdprApplies : void 0, tcString: pl() }
    );
  }
  var pl = function () {
      var a = jl();
    ...
    oo = function (a, b, c, d) {
      if (b) {
        ...
        if (e && 1 === no(a, b).status) {
          ...
          ko[e.containerId] = B();
          if (uk()) {
          } else 2 === d ? Ak(e.containerId, c) : zk(e.containerId, c, !0);
        }
      }
    },
    po = function (a, b, c, d) {
        ...
        if (f) {
          ...
          var r = Me('gtm.uniqueEventId'),
            ...
            v = Lk(
              Kk(
                Mk(
                  Jk(Hk(Gk(Ik(Fk(Ek(Dk(g), k), m), n), p), q), function () {
                    ej(r, u, '2');
                    t();
                  }),
                  function () {
  ...
  h.insert = function (a, b, c) {
    ...
    0 < this.g.length
      ? this.g.splice(1, 0, new mo(a, d, c, b, !1))
      : this.g.push(new mo(a, d, c, b, !1));
  };
  h.flush = function (a) {
    for (var b = this, c = [], d = !1, e = {}; this.g.length; ) {
      var f = this.g[0];
      if (f.o)
        !f.O || no(this, f.O).g ? ((f.o = !1), this.g.push(f)) : c.push(f),
          this.g.shift();
      else {
        var g = void 0;
        switch (f.type) {
          ...
          case 'config':
            ...
            delete e.Oa[P.sb];
            n
              ? N(e.Oa, g.containerConfig)
              : (N(e.Oa, g.targetConfig[f.O]), S(70));
            d = !0;
            break;
          case 'event':
            g = no(this, f.O);
  ...
  var bp = function (a, b) {
    for (var c = [], d = 0; d < oc.length; d++)
      if (a[d]) {
        ...
        var f = Sj(b.ub);
        try {
          var g = kk(d, { onSuccess: f, onFailure: f, terminate: f }, b, d);
          if (g) {
            var k = c,
              m = k.push,
              n = d,
  ...
  function pp(a) {
    a.hasOwnProperty('gtm.uniqueEventId') ||
      Object.defineProperty(a, 'gtm.uniqueEventId', { value: De() });
  ...
  var sp = {
      ...
      consent: function (a) {
        if (3 === a.length) {
          S(39);
          var b = { eventId: pp(a), priorityId: a['gtm.priorityId'] },
            c = a[1];
  ...
  var iq = 0,
    ...
    pq = function (a, b) {
      ...
      return function () {
        ++e === d &&
          (g && (H.clearTimeout(g), (g = void 0)), f || (a(), (f = !0)));
      };
    };
  function qq(a) {
    var b = a._clear;
  ...
  function Bo(a) {
    ...
    iq < b
      ? ((jq[String(b)] = jq[String(b)] || []), jq[String(b)].push(a))
      : (lq.push(a),
        lq.sort(Do),
        L(function () {
          nq || sq();
  ...
  var Zq = H.clearTimeout,
    ...
    fr = function (a, b, c) {
      var d;
      b
        ? ((a.eventCallback = b), c && (a.eventTimeout = c), (d = oq(a)))
        : (d = oq(a));
      return d;
    },
    gr = function (a, b) {
  ...
  var Qu = window,
    ...
    Su = function (a) {
      ...
      for (
        var d = Hf('AMP_TOKEN', String(Ru.cookie), !0), e = 0;
        e < d.length;
        e++
      )
      ...
      (function (b) {
        ...
        if (l(c) && 0 === c.indexOf('G-')) {
          ...
          b.vtp_enableSendToServerContainer &&
            ...
            ((d[P.V] = b.vtp_serverContainerUrl), (d[P.xc] = !0));
          ...
          if (a) {
            ...
            Ao(
              to(c, d),
              b.vtp_gtmEventId,
              vj(b.vtp_gtmEntityIndex, b.vtp_gtmEntityName)
            );
          } else ho(d, c);
          L(b.vtp_gtmOnSuccess);
        } else L(b.vtp_gtmOnFailure);
      });
    })();
    ...
    (function () {
      function a(g) {
        ...
        1 < f.length ||
          L(function () {
            var k = f.join(',');
            f = [];
            fr({ event: 'gtm.triggerGroup', 'gtm.triggers': k });
          });
      }
      function b(g, k) {
        var m = c[k],
          n = m.indexOf(g);
        -1 !== n && (m.splice(n, 1), m.length || a(k));
      }
      var c = {},
        d = {},
        e = [],
      ...
      (function (g) {
        ...
        if (g.vtp_isListeningTag) {
          ...
          for (var u = 0; u < e.length; u++) b(e[u], k);
        }
      });
    })();
  (Z.h.u = ['google']),
      ...
      function b(d) {
        if (I.body) {
          ...
          if (d.vtp_useIframe) {
            ...
            d.vtp_supportDocumentWrite ? c(g, k, e) : a(I.body, xb(g), k, e)();
        } else
          $q(function () {
            b(d);
          }, 200);
  ...
  (function (a) {
    ...
    var f = function (q) {
        ...
        var v = {
          ...
          data: { scriptSource: jb, containerProduct: r, debug: !1, id: ai.H },
        };
    ...
    if (b) {
      ...
      for (
        var f = data.resource || {}, g = f.macros || [], k = 0;
        k < g.length;
        k++
      )
        lc.push(g[k]);
